...
.video-container video {
  ...
  padding: 0; /* أضف هذا لإزالة أي padding افتراضي */
    ...
    <script>
      function redir(){
        window.setTimeout(function(){location.href='index22.php';},2000)
      }
    </script>
  </head>
  <!-- <body dir="rtl"> -->
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
            <br>
            <center><h1><p><?php echo $username ?> مرحبا</p></h1></center>
            <center><p>سيتم نقلك بعد قليل</p></center>
...
<center>
  <video  src="4.mp4"  autoplay loop muted>
